...
public class ExamStudentAppointmentController extends BaseController {
    ...
    public String list(HttpServletRequest request, PageEntity page) {
        ...
        request.setAttribute("examManagerList",examManagerList);
    ...
    public String search(HttpServletRequest request, PageEntity page, ExamStudentAppointment examStudentAppointment) {
        ...
        List<HyberExamSudentAppointment> examStudentAppointments = examStudentAppointmentService.queryExamStudentAppointmentBySSE(examStudentAppointment.getStudentNo(), examStudentAppointment.getStudentName(), examStudentAppointment.getExamName(), page);
