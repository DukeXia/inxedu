...
public class ExcelController extends BaseController{
	...
	@RequestMapping(value = "/toImportScore")
	public String toImportScore(HttpServletRequest request){
		log.info("ExcelController.toImportScore",request);
		return "/nstar/examExcel/importScore";
	}
	...
	public ModelAndView importScore(HttpServletRequest request,@RequestParam("myFile") MultipartFile myfile){
		ModelAndView modelAndView=new ModelAndView();
		String msg=excelService.updateExcelToScore(request,myfile);
		try {
	...
	@RequestMapping("/matchTeacherAndStudent")
	public String toMatchTeacherAndStudent(HttpServletRequest request){
		return "/nstar/examExcel/matchTeacherAndStudent";
	}

	@RequestMapping("/tomatchTeacherAndStudent")
	public ModelAndView matchTeacherAndStudent(HttpServletRequest request,
											   @RequestParam("myFile") MultipartFile myfile,
											   @RequestParam("mark") Integer mark){
		ModelAndView modelAndView=new ModelAndView();
		try{
			String msg=excelService.matchTeacherAndStudent(request,myfile);
			request.setAttribute("msg",msg);
			if(msg==null||msg.equals("")){
				modelAndView.setViewName("/common/success");
