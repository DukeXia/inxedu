...
public class ExamStudentAppointmentServiceImpl extends GenericDaoImpl implements ExamStudentAppointmentService {
    ...
    public void addExamStudentAppointment(StudentAppointment studentAppointment){
        this.insert("ExamStudentAppointmentMapper.save",studentAppointment);
    }
    ...
    @Override
    public List<HyberExamSudentAppointment> queryExamStudentAppointmentBySSE(String studentNo, String studentName, String examName, PageEntity page) {
        if("".equals(studentName)){
            studentName=null;
        }
        if ("".equals(examName)){
        ...
        examStudentAppointment.setStudentNo(studentNo);
        examStudentAppointment.setExamName(examName);
        List<HyberExamSudentAppointment> list=this.queryForListPage("ExamStudentAppointmentMapper.queryExamStudentAppointmentBySSE",examStudentAppointment,page);
        return list;
    }
