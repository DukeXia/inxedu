                   ...
                   // 读取左上端单元格
                    ...
                    if (row != null) {
                        ...
                        if (StringUtils.isEmpty(userName)) {
                            msg += "第" + i + "行  用户名 "+userName+" 不能为空<br/>";
                        }
                        ...
                        if (className == null || className.equals("")) {
                            msg += "第" + i + "行  班级"+className+"  不能为空<br/>";
                        } else {
                            ...
                            if (stuClassId == null) {
                                msg += "第" + i + "行  班级 "+className+ "在数据库不存在<br/>";
                            }
                        }
    ...
    public String updateExcelTocourseTableDo(HttpServletRequest request,
        ...
        try (InputStream inputStream = myFile.getInputStream()) {
            ...
            for (CourseTableDo it : list) {
                this.insert("CourseTableDoMapper.save", it);
