...
<head>
    <link href="/static/table/css/footable.core.css" rel="stylesheet" type="text/css" />
    <link href="/static/table/css/footable.standalone.css" rel="stylesheet" type="text/css" />
    <script type="text/javascript"	src="/static/table/js/jquery-1.9.1.min.js"></script>
    <script src="/static/table/js/footable.js" type="text/javascript"></script>
...
<article class="col-7 fl">
    <div class="u-r-cont">
        ...
        <section>
            ...
            <div class="">
                <div class="">
                    <table id="customers" class="footable">
                        <tr>
                            <th>ID</th>
                            <th>实验室</th>
                            <th>预约</th>
                            ...
                            <c:forEach items="${list}" var="x" varStatus="status">
                                    <c:if test="${x.number<=x.appointmentCount}">
                                        <tr class="special">
                                    </c:if>
                                    <c:if test="${x.number<=x.appointmentCount}">
                                        <tr class="special">
