...
<br>
<font size="6px">考试课程信息导入导出功能</font>
<form action="/admin/examExcel/exportExamCourse" method="post">
  <input type="submit" value="导出" />
</form>
<center><h1>导入功能</h1></center>
<div class="mt20">
    <div class="commonWrap">
		<form action="/admin/examExcel/importExamCourse" method="post" id="importP" enctype="multipart/form-data">
					...
					<tbody>
						<tr>
							...
							<td>excel模版说明：<br>
                                ...
                                第二列：考试课程名称<br>
                                第三列：备注
                                （<a href="${ctx}/static/common/import_student/import_examcourse.xlsx"  style="color: red;">点击下载模版</a>）<br>
							</td>
						</tr>
						<tr>
