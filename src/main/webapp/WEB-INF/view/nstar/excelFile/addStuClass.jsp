...
<br>
<font color="black" size="5px">导入导出班级</font><br>
<a href="/admin/excelFile/exportStuClass">
	<input value="导出班级" type="button"></a>
<div class="mt20">
    <div class="commonWrap">
		<form action="/admin/excelFile/importStuClass" method="post" id="importP" enctype="multipart/form-data">
					...
					<tbody>
						<tr>
							...
							<td>班级excel模版说明：<br>
                                ...
                                第二列：说明,可以空<br>
                                第三列：所属学院,不能空,与学院做关联
                                （<a href="${ctx}/static/common/import_student/import_stuclass.xlsx"  style="color: red;">点击下载模版</a>）<br>
							</td>
						</tr>
						<tr>
